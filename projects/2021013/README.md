...
Ολοκληρώνοντας και αυτό το μάθημα, Οπτικοποίηση της πληροφορίας, μπορούμε να συμπεράνουμε πως παρότι φαίνεται πως είναι παρόμοιο με τα προηγούμενα μάθηματα, Επικοινωνία-Ανθρώπου-Υπολογιστή και Συνεργατικά Συστήματα, κατέχει σημαντικές διαφορές που το κάνει να ξεχωρίζει με τον δικό του τρόπο. 
