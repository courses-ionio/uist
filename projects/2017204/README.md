...
| <a href="#P-3">4</a> |<a href="#P-3">Άσκηση Προγραμματισμού + Άιτημα Ενσωμάτωσης </a> |
| <a href="#P-4">5</a> |<a href="#P-4">Άσκηση Γραμμής Εντολών </a> |
| <a href="#P-5">6</a> |<a href="#P-5">Συμμετοχικό περιεχόμενο </a> |
...
Στο πρώτο παράδειγμα χρησιμοποίησα ένα διαδραστικό γράφημα όπου ο χρήστης μετακινώντας τον δείκτη του ποντικιού να μπορεί να βλέπει την οπτικοποίηση που έχει γίνει σε ένα στατιστικό παράδειγμα που έχει επιλέξει και έχει ο ίδιος αλλάξει με τα δικά του δεδομένα. Το αποτέλεσμα φαίνεται παρακάτω:
...
Στο δεύτερο παράδειγμα επέλεξα ένα μενού, όπου ο χρήστης πατώντας πάνω σε ένα button να ανοίγουν οι διάφορες κατηγορίες των δεδομένων, όπου έχει γίνει οπτικοποίηση. Το αποτέλεσμα φαίνεται παρακάτω:
