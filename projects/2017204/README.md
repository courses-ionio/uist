...
| <a href="#P-1">2</a> |<a href="#P-1">Πρώτη Άσκηση Προγραμματισμού </a> |
| <a href="#P-2">3</a> |<a href="#P-2">Πρώτη Άσκηση Γραμμής Εντολών </a> |
| <a href="#P-3">4</a> |<a href="#P-3">Δεύτερη Άσκηση Προγραμματισμού + Άιτημα Ενσωμάτωσης </a> |
| <a href="#P-4">5</a> |<a href="#P-4">Δεύτερη Άσκηση Γραμμής Εντολών </a> |
...
Για την υλοποίηση της παρακάτω εργασίας έκανα εγκατάσταση του spark: brew install spark. Έκανα clone το repository του μαθήματος iv και με βάση αυτό πραγματοποιήθηκε η συγκεκριμένη εργασία. Στη συνέχεια δημιούργησα ένα scrypt όπου ο χρήστης μπορεί να βλέπει γραφικά τα commits που έγιναν σε 10, 20 και 30 μέρες χωρίς να χρειάζεται να μπεί στον εκάστοτε φάκελο μελέτης κάθε φορα.
