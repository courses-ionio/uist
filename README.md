...
[Ανακοινώσεις, απορίες, και πρόγραμμα συναντήσεων](https://github.com/courses-ionio/iv/issues)

## Syllabus

**Περιγραφή:** Οπτικοποίηση της πληροφορίας και διάδραση, Ορισμός και ιστορική εξέλιξη, σχεδίαση της οπτικοποίησης, τεχνολογίες οπτικοποίησης: Γραφικά, Εικόνες, Βίντεο, Κείμενο, Ηχος, Σύγχρονες εφαρμογές οπτικοποίησης: Ψηφιακή Ειδησεογραφία, Μεγάλα δεδομένα, προσωπικά δεδομένα, λήψη αποφάσεων, πολιτισμός-τέχνη, εκπαίδευση.

**Προαπαιτούμενα:** Αντικειμενοστραφής προγραμματισμός, Επικοινωνία Ανθρώπου-Υπολογιστή (Αλγόριθμοι, Δομές Δεδομένων, Γραφικά, Πολυμέσα, Τεχνολογίες Διαδικτύου).
...
**Βαθμολογία:** 20% Τελική εξέταση* 20% [Συμμετοχικό εκπαιδευτικό υλικό*](https://github.com/courses-ionio/projects/blob/master/social/index.md) + 60% [6 ασκήσεις](https://github.com/courses-ionio/dokey) ή 60% [εργασία ανάπτυξης](https://courses-ionio.github.io/projects/dev/)
