...
Για φίλτρο `lua` χρησιμοποιήσα το ίδιο φίλτρο που έιχα δημιουργήσει στο μάθημα `Επικοινωνία Ανθρώπου - Υπολογιστή` με κάποιες παραμετροποιήσεις. Αρχικα, για να μπορέσω να εμφανισώ τις 4 διαφορετικές κατηγο
## Φωτογραφίες
