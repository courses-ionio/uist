...
| <a href="#Paradoteo7"> 10</a>  |<a href="#Paradoteo7">συμμετοχικό περιεχόμενο</a>|
| 11 | αίτημα ενσωμάτωσης (CSCW, IV) |
| <a href="#Paradoteo8"> 12</a>  |<a href="#Paradoteo8">τελική αναφορά</a>|
...
## <a name="Paradoteo8">:point_right: *Τελική Αναφορά*</a>
 
 *Σύνοψη
Έφτιαξα στο σύνολο δέκα παραδοτέα - τα δυο παραδοτέα είναι η τελική αναφορά και η εισαγωγή.
τα υπόλοιπα οκτώ παραδοτέα αποτελούνται από δυο συμμετοχικά περιεχόμενα , δυο άσκησης προγραμματισμού και δυο γραμμές εντολών και ένα έτοιμα ενσωμάτωσης.
Σε όλα τα παραδοτέα αναφέρω όλα τα εργαλεία και μεθόδους που ακολουθήθηκαν για να  πραγματοποιηθούν.

*Συμπεράσματα:
Μέσο των ασκήσεων του συμμετοχικού περιεχομένου έχω συγκεντρώσει γνώσεις  οι οποίες μπορούνε να με βοηθήσουν στο μέλλον. Γενικά οι ασκήσεις προγραμματισμού μου φανήκανε πολύ ενδιαφέρων και εμπλούτισε την γνώση μου σαν προγραμματιστής. οι  ασκήσεις γραμμής εντολών μου έχουν δείξει τα πλεονεκτήματα  χρήσης ενός τερματικού(terminal). Με το έτοιμα ενσωμάτωσης έχω μάθει πως πολλά άτομα μπορούν να βοηθήσουν για την πραγματοποίηση ενός project.
Σαν τελικό συμπέρασμα μπορώ να πω πως το μάθημα ήταν ένα πολύ καλό βοήθημα για την εκμάθηση τεχνικών οπτικοποίησης. Επίσης μπορώ να πω πως μετρά από το μάθημα έχω αποκτήσει προσωπικό ενδιαφέρον για το συγκεκριμένο κλάδο
