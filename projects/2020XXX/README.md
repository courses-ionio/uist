*Ενδεικτική Τελική Αναφορά που μπορείτε να χρησιμοποιήσετε ως υπόδειγμα. Σε κάθε περίπτωση πρέπει να ακολουθούνται οι **τρέχουσες οδηγίες για το [περιεχόμενο της αναφοράς](https://courses-ionio.github.io/help/deliverables/)***
