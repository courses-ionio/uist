...
Μετά την διαδικασία εγκατάστασης του, άνοιξα τον φάκελο με όνομα uxn με την εντολή `cd`. Ο φάκελος αυτός, πέραν του εκτελέσιμου αρχείου του εξομοιωτή, είχε και αρκετά εκτελέσιμα προγράμματα. Προσωπικά, δοκίμασα τα `calc.rom` και `nasu.rom`.
