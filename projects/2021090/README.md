...
| 7 | Εναλλακτικό σύστημα |[go!]()| Το uxn είναι δύσκολο στην πρώτη επαφή, θέλει χρόνο η assembly-like γλώσσα που χρησιμοποιεί ,είχε όμως ένα ενδιαφέρον κσι μια πρόκληση όπου και κατάφερα να πραγματοποιήσω μια μικρή αλλαγή σε ένα πρότζεκτ|
| 8 | Άσκηση γραμμής εντολών (cli data analysis) |[go!]()|Μια πιο δημιουργική προσέγγιση στην οπτικοποήση κειμένου: Wordcloud|
| 9 | Αίτημα ενσωμάτωσης |[go!]()|Δημιούργησα ένα φίλτρο που μπορεί να διάζει και να γράφει ολα τα αρχεία των εργαστηρίων, θεψρώ πως είναι πετυχημένο|
| 10 | Τελική αναφορά |[go!]()|Τα τελικά μου συμπεράσματα|
