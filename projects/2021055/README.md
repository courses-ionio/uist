...
| 9 | Αίτημα ενσωμάτωσης | https://github.com/courses-ionio/iv/discussions/35 | Δημιούργησα τέσσερα φίλτρα για την αναπάραστη της κάθε κατηγορίας των καθηγητών, επίσης πρόσθεσα όλο το περιεχόμενο στο αρχείο ch02.txt, πιστευώ ότι ήταν μια αρκετά καλή προσπάθεια. `9/10`
